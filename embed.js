document.addEventListener("DOMContentLoaded", async () => {
  ...
  try {
    ...
    target.innerHTML = games.map(game => `
      ...
      >
        <img src="${apiUrl}/${game.alt}.webp" alt="${game.title} thumbnail" style="width:100%; border-radius:8px; height: 120px; object-fit: cover;" onerror="this.onerror=null;this.src='https://placehold.co/200x120/cccccc/333333?text=No+Image';" />
